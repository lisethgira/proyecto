...
<head>
  ...
  <body>
    <div class="container">
      <h1 class="text-center mb-4 mt-5<meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="olvidarPass.php">Olvide mi contraseña</a>
                                </div>
                                <div class="text-center">
                                    <a class="small" href="login.php">¡ya tengo una cuenta!</a>
                                </div>
                            </div>
                        </div>
                    </div>
